        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Specialized in data extraction, preprocessing, and visualization. Creating interactive dashboards and deriving actionable insights to drive data-informed business decisions and strategy optimization.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Creating visually engaging digital content and designs. Proficient in UI/UX design tools and video editing to deliver compelling visual narratives and engaging multimedia experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Visual Communication</div>
